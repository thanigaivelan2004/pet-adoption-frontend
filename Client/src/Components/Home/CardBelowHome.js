...
const CardBelowHome = () => {
  ...
  return (
    <div className='dark-grey-container'>
      ...
      <div className='left-para'><p><p className='adopted-pets-num'>{adoptedPets}</p> Pets<br/>Livin their Life Easy</p></div>
      <div className='right-pic'><img src={HomeDarkCardRightPic} alt="Dog pic" /></div>
      <div className='right-para'><p className='we-do'>WHAT WE DO?</p>we are focus to give the right pet to the right person.</div>
    </div>
  )
}
